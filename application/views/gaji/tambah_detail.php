  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('tambah-detail-gaji/'.$id_gaji); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="gaji_pokok" class="form-control" id="gaji_pokok" value="<?= set_value('gaji_pokok'); ?>" required="">
                  <?= form_error('gaji_pokok', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Bonus</label>
                  <input type="number" name="bonus" class="form-control" value="<?= set_value('bonus'); ?>" required="">
                  <?= form_error('bonus', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Kasbon</label>
                  <input type="number" name="kasbon" class="form-control" value="<?= set_value('kasbon'); ?>" required="">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="rekening_penerima" id="rekening_pegawai" class="form-control" value="<?= set_value('rekening_penerima'); ?>" required="">
