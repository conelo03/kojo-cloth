  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('tambah-rekening'); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_rekening" class="form-control" value="<?= set_value('nama_rekening'); ?>" required="">
                  <?= form_error('nama_rekening', '<span class="text-danger small">', '</span>'); ?>
                </div> 
                <div class="form-group">
                  <label>Bank</label>
                  <input type="text" name="bank" class="form-control" value="<?= set_value('bank'); ?>" required="">
