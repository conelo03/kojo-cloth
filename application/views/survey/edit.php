  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Detail Survey</div>
      </div>
    </div>
            ...
            <form action="#" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <textarea type="text" name="saran" class="form-control" disabled=""><?= $s['saran'] ?></textarea>
                </div>
              </div>

              <div class="card-footer text-right">
                <a href="<?= base_url('survey');?>" class="btn btn-light"><i class="fa fa-arrow-left"></i> Kembali</a>
              </div>
            </form>
          </div>
        </div>
