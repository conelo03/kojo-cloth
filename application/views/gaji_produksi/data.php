                ...
                <table class="table table-striped" id="datatables-user">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php if(is_owner()): ?>
                        <?php if($u['status'] == 1): ?>
                          <button class="btn btn-success" data-confirm="Anda yakin ingin menyetujui data gaji ini?|Data yang sudah disetujui tidak akan bisa diedit kembali." data-confirm-yes="document.location.href='<?= base_url('approve-gaji-produksi/'.$u['id_gaji_produksi']); ?>';"><i class="fa fa-check"></i> Approve</button>
