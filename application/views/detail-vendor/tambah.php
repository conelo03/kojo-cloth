  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Tambah Katalog Vendor</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('tambah-detail-vendor/'.$id_vendor); ?>" method="post" enctype="multipart/form-data">
              <div class="card-header">
                <h4>Form Tambah Katalog Vendor</h4>
              </div>
              <div class="card-body">
