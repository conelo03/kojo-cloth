  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('edit-order-pelanggan/'.$order['id_order']); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Jumlah (Ukuran S)</label>
                      <input type="number" name="jumlah_ukuran_s_p" class="form-control" value="<?= set_value('jumlah_ukuran_s_p', $order['jumlah_ukuran_s_p']); ?>" required="">
                      <?= form_error('jumlah_ukuran_s_p', '<span class="text-danger small">', '</span>'); ?>
                    </div>
                    <div class="form-group">
                      <label>Jumlah (Ukuran M)</label>
                      <input type="number" name="jumlah_ukuran_m_p" class="form-control" value="<?= set_value('jumlah_ukuran_m_p', $order['jumlah_ukuran_m_p']); ?>" required="">
                      <?= form_error('jumlah_ukuran_m_p', '<span class="text-danger small">', '</span>'); ?>
                    </div>
                    <div class="form-group">
                      <label>Jumlah (Ukuran L)</label>
                      <input type="number" name="jumlah_ukuran_l_p" class="form-control" value="<?= set_value('jumlah_ukuran_l_p', $order['jumlah_ukuran_l_p']); ?>" required="">
                      <?= form_error('jumlah_ukuran_l_p', '<span class="text-danger small">', '</span>'); ?>
                    </div>
                    <div class="form-group">
                      <label>Jumlah (Ukuran XL)</label>
                      <input type="number" name="jumlah_ukuran_xl_p" class="form-control" value="<?= set_value('jumlah_ukuran_xl_p', $order['jumlah_ukuran_xl_p']); ?>" required="">
                      <?= form_error('jumlah_ukuran_xl_p', '<span class="text-danger small">', '</span>'); ?>
                    </div>
                    <div class="form-group">
                      <label>Jumlah (Ukuran XXL)</label>
                      <input type="number" name="jumlah_ukuran_xxl_p" class="form-control" value="<?= set_value('jumlah_ukuran_xxl_p', $order['jumlah_ukuran_xxl_p']); ?>" required="">
